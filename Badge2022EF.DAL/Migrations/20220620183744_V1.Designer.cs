...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Badge2022EF.DAL.Entities.ArmoireEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Badge2022EF.DAL.Entities.ArmoiresStockEntity", b =>
                {
            ...
            modelBuilder.Entity("Badge2022EF.DAL.Entities.MedecinEntity", b =>
                {
            ...
            modelBuilder.Entity("Badge2022EF.DAL.Entities.MedicamentEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Badge2022EF.DAL.Entities.OrdonnanceEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Badge2022EF.DAL.MedicamentsPrescritEntity", b =>
                {
            ...
            modelBuilder.Entity("Badge2022EF.DAL.PharmacyEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Badge2022EF.DAL.Entities.ArmoireEntity", b =>
                {
                    b.HasOne("Badge2022EF.DAL.Entities.PersonneEntity", "Patient")
                        .WithMany("Armoires")
            ...
            modelBuilder.Entity("Badge2022EF.DAL.Entities.ArmoiresStockEntity", b =>
                {
                    b.HasOne("Badge2022EF.DAL.Entities.ArmoireEntity", "Armoire")
                        .WithMany("ArmoiresStocks")
                        .HasForeignKey("Armoireid")
                        .IsRequired()
                        .HasConstraintName("FK_ArmoiresStockEntity_ArmoiresEntity");

                    b.HasOne("Badge2022EF.DAL.Entities.MedicamentEntity", "Medi")
                        .WithOne("ArmoiresStock")
                        .HasForeignKey("Badge2022EF.DAL.Entities.ArmoiresStockEntity", "Mediid")
                        .IsRequired()
                        .HasConstraintName("FK_MedicamentEntity_ArmoiresStockEntity");

                    b.HasOne("Badge2022EF.DAL.Entities.OrdonnanceEntity", "Ordonnance")
                        .WithMany("ArmoiresStocks")
            ...
            modelBuilder.Entity("Badge2022EF.DAL.Entities.OrdonnanceEntity", b =>
                {
                    b.HasOne("Badge2022EF.DAL.Entities.MedecinEntity", "Medecin")
                    ...
                    b.HasOne("Badge2022EF.DAL.PharmacyEntity", "Pharmacie")
                        .WithMany("Ordonnances")
            ...
            modelBuilder.Entity("Badge2022EF.DAL.Entities.PersonneEntity", b =>
                {
                    b.HasOne("Badge2022EF.DAL.RoleEntity", "Roles")
                        .WithMany("Personnes")
            ...
            modelBuilder.Entity("Badge2022EF.DAL.MedicamentsPrescritEntity", b =>
                {
                    b.HasOne("Badge2022EF.DAL.Entities.MedicamentEntity", "Medicament")
                        .WithMany()
